module ariga.io/atlas-provider-gorm/gormschema/dialect/spanner
...
require (
	ariga.io/atlas-provider-gorm v0.0.0-00010101000000-000000000000
...
replace ariga.io/atlas-provider-gorm => ../../../
