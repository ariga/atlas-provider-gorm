...
func (s *Session) StrStmts() string {
...
func (md *drv) Open(name string) (driver.Conn, error) {
	mu.Lock()
	defer mu.Unlock()
...
func (mr *Response) Columns() []string {
	return mr.Cols
}

// Close closes the rows iterator. It is a noop.
func (mr *Response) Close() error {
	return nil
}
